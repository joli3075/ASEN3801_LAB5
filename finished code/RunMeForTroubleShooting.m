...
% StateTest0 = [ 0, 0 , -18000, deg2rad(15) , deg2rad(-12) , deg2rad(270) , 19 , 3 , -2 , deg2rad(0.08) , deg2rad(-0.2) ,0];StateTest0 = [ 0, 0 , -18000, deg2rad(15) , deg2rad(-12) , deg2rad(270) , 19 , 3 , -2 , deg2rad(0.08) , deg2rad(-0.2) ,0];
...
[t, state_vector3] = ode45(@(t, y) AircraftEOM(time, y, aircraft_surfaces, wind_inertial, aircraft_parameters), time, StateTest0);
